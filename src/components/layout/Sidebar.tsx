...
export const Sidebar: React.FC<SidebarProps> = ({
  ...
  return (
    <>
      ...
      {/* Mobile Drawer Sidebar (floating toggle button in App) */}
      {mobileOpen && (
        <>
          {/* Backdrop — clicking it closes the drawer */}
          <div
            className="md:hidden fixed inset-0 top-[72px] bg-black/50 backdrop-blur-xs z-40 animate-in fade-in duration-150"
